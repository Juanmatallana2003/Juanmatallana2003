...
Tecnólogo en Análisis y Desarrollo de Software (SENA), recién egresado y listo para iniciar etapa productiva. Construyo aplicaciones web full stack con JavaScript, TypeScript, Python y Java, con experiencia práctica en proyectos de equipo reales durante la Fábrica de Software del SENA.
